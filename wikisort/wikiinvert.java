...
public class wikiinvert {
  ...
  public static void main(String[] args) throws Exception {
     ...
     */
    job.setJarByClass(wikiinvert.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("Tweet Word Invert");
     ...
     */
    job.setMapperClass(wikiInvertMapper.class);
    job.setReducerClass(wikiInvertReducer.class);
